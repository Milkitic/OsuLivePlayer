...
namespace OsuLivePlayer.Model.DxAnimation
{
    ...
    {
        public StringObject(RenderTarget target, string words, Gdip.Font font, Gdip.Brush brush, Point initPosision,
            bool enableLog = false) : base(target, GetStringBitmap(target, words, font, brush), initPosision, enableLog) { }

        public StringObject(RenderTarget target, Bitmap bitmap, Point initPosision, bool enableLog = false)
        ...
        public new StringObject Reset(Point posision) => new StringObject(Target, Bitmap, posision, EnableLog);
    }
}
